...
def get(seed=1, pc_valid=0.10):
    ...
    if not os.path.isdir('./data/Five_data/binary_mixture_8_Data/'):
        os.makedirs('./data/Five_data/binary_mixture_8_Data')
        # Pre-load
        for n,idx in enumerate(idata):
            if idx==0:
                ...
                std=[x/255 for x in [63.0,62.1,66.7]]
                dat={}
                dat['train']=datasets.CIFAR100('./Five_data/',train=True,download=True,transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                dat['test']=datasets.CIFAR100('./Five_data/',train=False,download=True,transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                data[n]={}
                ...
                dat={}
                dat['train']=TrafficSigns('./data/Five_data/traffic_signs', train=True, download=True, transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                dat['test']=TrafficSigns('./data/Five_data/traffic_signs', train=False, download=True, transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                ...
                dat={}
                dat['train']=Facescrub('./data/Five_data/facescrub', train=True, download=True, transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                dat['test']=Facescrub('./dat/Five_Data/facescrub', train=False, download=True, transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
            ...
            for s in ['train','test']:
                ...
                torch.save(data[n][s]['x'], os.path.join(os.path.expanduser('./data/Five_data/binary_mixture_8_Data'),'data'+str(idx)+s+'x.bin'))
                torch.save(data[n][s]['y'], os.path.join(os.path.expanduser('./data/Five_data/binary_mixture_8_Data'),'data'+str(idx)+s+'y.bin'))
        ...
        for n,idx in enumerate(idata):
            ...
            for s in ['train','test']:
                data[n][s]={'x':[],'y':[]}
                data[n][s]['x'] = torch.load(os.path.join(os.path.expanduser('./data/Five_data/binary_mixture_8_Data'),'data'+str(idx)+s+'x.bin'))
                data[n][s]['y'] = torch.load(os.path.join(os.path.expanduser('./data/Five_data/binary_mixture_8_Data'),'data'+str(idx)+s+'y.bin'))
